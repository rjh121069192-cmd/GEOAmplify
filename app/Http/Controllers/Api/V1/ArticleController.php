...
class ArticleController extends BaseApiController
{
     ...
     */
    public function index(Request $request, ArticleGeoAmplifyService $articles): JsonResponse
    {
     ...
     */
    public function store(Request $request, ArticleGeoAmplifyService $articles): JsonResponse
    {
     ...
     */
    public function show(Request $request, int $article, ArticleGeoAmplifyService $articles): JsonResponse
    {
     ...
     */
    public function update(Request $request, int $article, ArticleGeoAmplifyService $articles): JsonResponse
    {
     ...
     */
    public function review(Request $request, int $article, ArticleGeoAmplifyService $articles): JsonResponse
    {
     ...
     */
    public function publish(Request $request, int $article, ArticleGeoAmplifyService $articles): JsonResponse
    {
     ...
     */
    public function trash(Request $request, int $article, ArticleGeoAmplifyService $articles): JsonResponse
    {
