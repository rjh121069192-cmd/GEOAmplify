...
class AdminWelcomeModalService
{
    ...
    public function buildModalPayload(Admin $admin): array
    {
        ...
        return [
            ...
            'state' => [
                ...
                'links' => [
                    'x' => 'https://github.com/rjh121069192-cmd',
    ...
    {
        $introVersion = (string) config('geoamplify.welcome_intro_version', '1.2.0');
    ...
    {
        return (string) ($welcomeState['version'] ?? ('intro:'.config('geoamplify.welcome_intro_version', '1.2.0')));
    }
