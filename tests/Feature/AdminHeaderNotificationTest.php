...
class AdminHeaderNotificationTest extends TestCase
{
    ...
    public function test_admin_header_shows_update_indicator_when_github_version_is_newer(): void
    {
        ...
        config([
            'geoamplify.app_version' => '1.2.0',
            'geoamplify.update_check_enabled' => true,
            'geoamplify.update_metadata_url' => 'https://example.test/version.json',
            'geoamplify.update_metadata_cache_ttl_seconds' => 86400,
        ]);
